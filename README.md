...
## How to use it 
```
# change smoke_testing.js and package.json for your project
npm install .
...
To try out any of the other examples, just copy the content of your example file of choice into `smoke_testing.js`
